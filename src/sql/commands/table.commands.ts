...
export class SQLTableCommand {
    
    constructor(readonly table: string) {}
    

    // renameColumn(old_name: string, new_name: string): SQLCommandAdapter {
    //     return {
    ...
    // changeColumnType(column: string, type: string): SQLCommandAdapter {
    //     return {
