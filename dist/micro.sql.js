...
var MicroSQL;
(function (MicroSQL) {
    function dataSourceQuery(dataSource, cb) {
        return __awaiter(this, void 0, void 0, function () {
            var dbType, query, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        dbType = dataSource.options.type;
                        if (!(typeof cb == 'function')) return [3 /*break*/, 2];
                        return [4 /*yield*/, cb(dbType, dataSource.options.database)];
                    case 1:
                        _a = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    MicroSQL.dataSourceQuery = dataSourceQuery;
