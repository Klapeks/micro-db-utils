...
var logger = new utils_1.Logger("Kafka Producer");
var KafkaProducer = /** @class */ (function () {
    function KafkaProducer(connection, config) {
    ...
    KafkaProducer.prototype.sendMessage = function (topic, data, options) {
        return __awaiter(this, void 0, void 0, function () {
            var message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.producer.send({ topic: topic, messages: [message] })];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
