...
import { ISQLCommandAdapter, SQLAlterCommand, SQLCommandData, SQLEditDataCommands, SQLSelectCommands, SQLTablesCommands, SQLTimeCommandsExpressions } from "./sql";
...
export declare namespace MicroSQL {
    ...
    function editData(table: string): SQLEditDataCommands;
